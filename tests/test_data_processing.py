...
def test_get_category_tags_single(tag_dict) -> None:
    ...
    expected = dict(category="cs.CV", subject="Computer Science")
    assert result == expected
...
def test_get_category_tags_fail(tag_dict) -> None:
    ...
    result = get_category_tags(example, tag_dict)
    expected = dict(primary_category=None, subject=None)
    assert result == expected
...
def test_get_category_tags_double(tag_dict) -> None:
    ...
    result = get_category_tags(example, tag_dict)
    expected = dict(primary_category="cs.AI", subject="Computer Science")
    assert result == expected
...
def test_get_category_tags_single_withmissing(tag_dict) -> None:
    ...
    result = get_category_tags(example, tag_dict)
    expected = dict(primary_category="nlin.CD", subject="Physics")
    assert result == expected
...
def test_get_category_tags_single_repeatingsubstring(tag_dict) -> None:
    ...
    result = get_category_tags(example, tag_dict)
    expected = dict(primary_category="astro-ph.SR", subject="Physics")
    assert result == expected
...
def test_get_category_tags_double_repeatingsubstring(tag_dict) -> None:
    ...
    result = get_category_tags(example, tag_dict)
    expected = dict(category="astro-ph.CO", subject="Physics")
    assert result == expected
...
def test_get_category_tags_double_repeatingsubstring_missing(tag_dict) -> None:
    ...
    example = dict(
        categories=[
            "Physics Archive->astro-ph->astro-ph.XY",
            "Physics Archive->astro-ph->astro-ph.SR",
        ]
    )
    result = get_category_tags(example, tag_dict)
    expected = dict(category="astro-ph.SR", subject="Physics")
    assert result == expected
